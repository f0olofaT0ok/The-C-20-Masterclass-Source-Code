...
int main(){
    ...
    // signed short int signed_short_int {-32000}; // 
    // unsigned short int unsigned_short_int {65534};
    ...
    // short myvar {4};
    short signed int myvar {4};
    double bytesize = sizeof(myvar);
    
    std::cout << "default short variable: " << myvar << std::endl;
    std::cout << "The byte size is: " << bytesize << std::endl;
    std::cout << "The integer size is: " << pow(pow(2, 8),bytesize) << std::endl;
